...
export const HOME_ERAS: readonly HomeEraPresentation[] = [
  {
    ...
    name: '先秦',
    years: '约前 2070—前 221',
    cover: publicAssetUrl('/assets/courses/covers/C-prequin-state-720.webp'),
    subjectBase: publicAssetUrl('/assets/home-era/preqin'),
  ...
  },
  {
    ...
    name: '秦汉',
    years: '前 221—220',
    cover: publicAssetUrl('/assets/courses/covers/C-qinhan-founding-720.webp'),
    subjectBase: publicAssetUrl('/assets/home-era/qinhan'),
  ...
  },
  {
    ...
    name: '魏晋南北朝',
    years: '220—589',
    cover: publicAssetUrl('/assets/courses/covers/C-weijin-fusion-720.webp'),
    subjectBase: publicAssetUrl('/assets/home-era/weijin'),
  ...
  },
  {
    ...
    name: '隋唐',
    years: '581—907',
    cover: publicAssetUrl('/assets/courses/covers/C-suitang-tang-720.webp'),
    subjectBase: publicAssetUrl('/assets/home-era/suitang'),
  ...
  },
  {
    ...
    name: '宋元',
    years: '960—1368',
    cover: publicAssetUrl('/assets/courses/covers/C-songyuan-song-720.webp'),
    subjectBase: publicAssetUrl('/assets/home-era/songyuan'),
  ...
  },
  {
    ...
    name: '明清',
    years: '1368—1912',
    cover: publicAssetUrl('/assets/courses/covers/C-mingqing-late-720.webp'),
    subjectBase: publicAssetUrl('/assets/home-era/mingqing'),
