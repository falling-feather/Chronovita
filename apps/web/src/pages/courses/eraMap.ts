...
export interface EraOverlay {
  ...
  /** 朝代版图 outline (SVG path)；缺省回退到通用 CHINA_OUTLINE。
   *  说明：示意性绘制，反映各时代疆域的扩张/收缩特征，不严格到县。 */
  outline?: string;
}
...
export const ERA_OVERLAYS: EraOverlay[] = [
  {
    ...
    // 先秦版图：中原 + 关中 + 齐鲁 + 江淮 + 战国末期巴蜀；未含河西/岭南/辽东/西域/青藏
    outline:
      'M 300 300 C 320 260 380 240 460 235 C 540 235 600 248 645 275 ' +
      'C 660 295 660 322 648 348 C 660 380 656 420 638 450 ' +
      'C 615 480 575 498 520 502 C 460 506 405 498 358 478 ' +
      'C 320 462 298 432 290 396 C 286 360 290 320 300 300 Z',
    tracks: [
      {
        id: 'zhou-fengjian',
        name: '周王畿与诸侯封域',
  ...
  },
  {
    ...
    // 秦汉版图：加河西走廊、岭南、辽东、海南；西汉冿州以西以属状企主，不划入主体轮廓
    outline:
      'M 220 270 C 290 240 380 218 470 215 C 570 215 650 232 705 258 ' +
      'C 730 285 720 318 690 330 C 660 332 632 332 622 348 ' +
      'C 628 374 660 388 690 402 C 706 425 700 458 678 472 ' +
      'C 648 488 612 500 580 512 C 595 542 590 575 568 592 ' +
      'C 535 605 498 600 468 588 C 438 600 408 600 380 590 ' +
      'C 348 575 320 552 308 522 C 288 488 268 450 252 412 ' +
      'C 230 380 215 340 215 300 C 215 285 215 278 220 270 Z ' +
      // 海南岛
      'M 528 622 C 540 614 558 614 568 622 C 574 632 570 644 558 648 ' +
      'C 542 650 528 644 524 636 C 522 630 524 626 528 622 Z',
    tracks: [
      {
        id: 'great-wall-han',
        name: '汉长城',
  ...
  },
  {
    ...
    // 魏晋南北朝版图：分裂期，西域仅前涼短暂控制 → 不划入；北边在柔然/突厥压迫下收缩；南延至交趾
    outline:
      'M 240 290 C 300 262 380 240 470 235 C 560 237 638 252 680 280 ' +
      'C 700 308 685 328 652 335 C 624 342 608 358 618 380 ' +
      'C 642 405 660 432 648 462 C 620 484 580 496 545 506 ' +
      'C 562 538 555 572 525 588 C 492 600 455 595 425 580 ' +
      'C 395 590 365 588 340 575 C 312 558 292 528 285 498 ' +
      'C 275 460 265 422 256 384 C 248 348 240 318 240 290 Z ' +
      // 海南岛
      'M 528 622 C 540 614 558 614 568 622 C 574 632 570 644 558 648 ' +
      'C 542 650 528 644 524 636 C 522 630 524 626 528 622 Z',
    tracks: [
  ...
  },
  {
    ...
    // 隋唐版图：盛世最广 — 加西域（安西北庭）、漠北都护、青藏为吐蕃外藩（以虚线示意在另一层）、台湾流求
    outline:
      'M 100 248 C 170 218 270 198 380 195 C 490 195 590 208 670 222 ' +
      'C 728 244 752 275 738 308 C 720 338 690 348 660 342 ' +
      'C 638 338 622 350 624 372 C 645 398 668 425 660 460 ' +
      'C 644 488 615 506 580 520 C 590 552 580 588 555 605 ' +
      'C 520 615 480 605 445 590 C 410 600 378 598 350 585 ' +
      'C 318 568 295 542 285 510 C 268 478 248 448 235 420 ' +
      'C 215 408 188 408 162 400 C 130 388 105 358 108 322 ' +
      'C 115 290 105 268 100 248 Z ' +
      // 海南岛
      'M 528 622 C 540 614 558 614 568 622 C 574 632 570 644 558 648 ' +
      'C 542 650 528 644 524 636 C 522 630 524 626 528 622 Z ' +
      // 流求（台湾）
      'M 678 538 C 686 532 698 538 700 552 C 702 572 696 596 686 612 ' +
      'C 678 622 670 618 668 606 C 666 588 670 562 678 538 Z',
    tracks: [
      {
        id: 'grand-canal-sui',
        name: '隋唐大运河',
  ...
  },
  {
    ...
    // 宋元版图：以元皆为代表（最大版图）— 含蒙古高原、新疆、青藏、云南、东北女真、海南台湾
    outline:
      'M 80 215 C 140 192 220 175 320 170 C 440 168 560 175 660 195 ' +
      'C 720 215 752 248 740 285 C 718 308 685 308 660 298 ' +
      'C 638 295 624 302 622 318 C 632 345 660 355 690 365 ' +
      'C 705 388 695 420 670 432 C 640 446 612 450 598 465 ' +
      'C 608 495 612 530 595 558 C 580 582 555 595 528 605 ' +
      'C 510 614 488 612 470 605 C 442 615 410 612 380 595 ' +
      'C 348 580 320 558 305 530 C 285 500 265 470 248 442 ' +
      'C 220 425 180 420 145 408 C 105 392 78 360 78 320 ' +
      'C 78 285 80 245 80 215 Z ' +
      // 海南岛
      'M 528 622 C 540 614 558 614 568 622 C 574 632 570 644 558 648 ' +
      'C 542 650 528 644 524 636 C 522 630 524 626 528 622 Z ' +
      // 台湾
  ...
  },
  {
    ...
    // 明清版图：以清乾隆全盛为代表 — 含外蒙古、新疆、外东北、藏；北界、东北界顺峰朝代变最完整
    outline:
      'M 70 210 C 130 185 210 165 310 160 C 430 158 555 165 660 180 ' +
      'C 720 195 760 220 770 250 C 775 282 745 305 712 308 ' +
      'C 680 308 658 318 658 340 C 678 360 700 378 700 408 ' +
      'C 690 432 660 442 632 448 C 615 478 622 510 605 540 ' +
      'C 588 568 558 590 528 600 C 510 612 488 610 470 605 ' +
      'C 442 615 410 612 380 595 C 348 580 320 558 305 530 ' +
      'C 285 500 265 470 248 442 C 220 425 180 420 145 408 ' +
      'C 100 390 70 358 68 318 C 68 280 70 240 70 210 Z ' +
      // 海南岛
      'M 528 622 C 540 614 558 614 568 622 C 574 632 570 644 558 648 ' +
      'C 542 650 528 644 524 636 C 522 630 524 626 528 622 Z ' +
      // 台湾
...
// 9 大水系 — v0.3.0 校准：与城市坐标对齐，黄河走 "几" 字大弯，长江贯穿宜昌-江陵-武汉-南京-上海
export const RIVERS = [
  // 黄河 · 青海源头 → 兰州 → 河套北凸 → 山陕南折 → 龙门-潼关 → 洛阳北 → 开封北 → 济南北 → 东营入海
  {
    id: 'yellow',
    name: '黄河',
    color: '#D4A95C',
    geometry:
      'M 196 360 C 220 354 246 348 268 346 ' +
      'C 296 342 312 320 314 290 ' +
      'C 316 268 312 250 318 236 ' +
      'C 348 230 388 230 426 232 ' +
      'C 452 234 462 250 458 282 ' +
      'C 454 322 444 350 446 360 ' +
      'C 452 372 466 366 484 362 ' +
      'C 514 358 544 348 578 340 ' +
      'C 608 332 638 326 662 322',
  },
  // 长江 · 唐古拉 → 横断 → 宜宾-重庆 → 宜昌-江陵(488,458) → 武汉 → 九江 → 南京(600,432) → 上海入海
  {
    id: 'yangtze',
    name: '长江',
    color: '#5BA3D0',
    geometry:
      'M 178 478 C 215 488 248 492 280 490 ' +
      'C 320 488 355 472 392 466 ' +
      'C 432 460 466 460 488 458 ' +
      'C 520 458 552 452 578 442 ' +
      'C 600 434 626 428 660 426 ' +
      'C 678 425 692 426 700 428',
  },
  // 珠江 · 西江 → 广州(560,582) → 入海口
  {
    id: 'pearl',
    name: '珠江',
    color: '#5BA3D0',
    geometry:
      'M 360 582 C 415 578 470 580 510 582 C 540 583 562 584 600 590',
  },
  // 雅鲁藏布江 · 喜马拉雅北麓
  {
    id: 'yarlung',
    name: '雅鲁藏布江',
    color: '#5BA3D0',
    geometry: 'M 110 488 C 160 480 220 484 268 488 C 296 490 320 488 340 484',
  },
  // 澜沧江-湄公河 · 三江并流南下
  {
    id: 'lancang',
    name: '澜沧江',
    color: '#5BA3D0',
    geometry: 'M 290 470 C 304 500 316 530 328 558 C 338 583 348 603 360 622',
  },
  // 松花江 · 哈尔滨方向
  {
    id: 'songhua',
    name: '松花江',
    color: '#5BA3D0',
    geometry: 'M 615 198 C 648 218 682 234 708 252 C 724 266 736 280 740 294',
  },
  // 辽河 · 沈阳一带
  {
    id: 'liao',
    name: '辽河',
    color: '#5BA3D0',
    geometry: 'M 600 250 C 615 274 630 294 645 318',
  },
  // 海河 · 北京-天津
  {
    id: 'hai',
    name: '海河',
    color: '#5BA3D0',
    geometry: 'M 482 304 C 510 312 535 318 562 322',
  },
  // 淮河 · 黄河南、长江北
  {
    id: 'huai',
    name: '淮河',
    color: '#5BA3D0',
    geometry: 'M 470 412 C 508 415 545 418 580 420',
  },
];

// 主要山脉脊线 — v0.3.0 新增：作为南北/东西分界的视觉锚点
export const MOUNTAINS = [
  // 喜马拉雅 · 中印边界弧
  {
    id: 'himalaya',
    name: '喜马拉雅',
    geometry: 'M 100 504 C 160 498 220 500 280 504 C 312 506 332 504 348 500',
  },
  // 阴山 · 河套以北
  {
    id: 'yinshan',
    name: '阴山',
    geometry: 'M 312 252 C 350 246 400 244 450 248',
  },
  // 燕山 · 北京以北
  {
    id: 'yanshan',
    name: '燕山',
    geometry: 'M 510 268 C 540 262 580 260 620 264',
  },
  // 太行 · 山西河北界（南北走向）
  {
    id: 'taihang',
    name: '太行',
    geometry: 'M 478 282 C 472 318 470 348 472 380',
  },
  // 秦岭 · 关中-汉中分界（东西走向，黄河长江流域分水）
  {
    id: 'qinling',
    name: '秦岭',
    geometry: 'M 320 402 C 360 398 400 398 440 402 C 470 404 490 404 510 406',
  },
  // 大别 · 鄂豫皖
  {
    id: 'dabie',
    name: '大别',
    geometry: 'M 510 432 C 535 430 560 432 580 436',
  },
  // 南岭 · 湘赣粤
  {
    id: 'nanling',
    name: '南岭',
    geometry: 'M 440 552 C 480 548 520 548 560 552',
  },
  // 横断山 · 川西南北纵列
  {
    id: 'hengduan',
    name: '横断山',
    geometry: 'M 285 462 C 290 500 295 540 304 580',
  },
];
