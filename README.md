...
> 面向中小学历史教学与历史仿真创新训练的 AI 实践平台。当前开发版本 **V0.10.25**；原创学生端视觉系统已覆盖展馆式全局壳、系统时间日晷首页、山河课程中心、可缩放历史地图、15 门独立课程头图、课程路线、通栏导读短片、交互式史卷阅读、人物助教浮窗、双旗舰历史情景推演与“问史卷”。双旗舰课可接受自然问法，在当前不可变发布内完成多路检索、证据约束回答和可展开引用；本地学习书案继续按长期任务推进。最终 prerelease 仍须经过用户验收和发行物复核，不宣称公网或多学校生产部署已经完成。
