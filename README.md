...
> 面向中小学历史教学与历史仿真创新训练的 AI 实践平台。当前版本 **V0.9.35**；`class` 分支已接通确定性课程归档、GitHub PR 后端链路、教师发布界面和无密钥 Windows 教师包，并完成完整历史扫描、DPAPI 验收读取和跨 PowerShell 模块路径兼容修复。首个 GitHub Release 尚待新标签流水线验收，最终整链审查由 V0.9.36 收口。
