...
> 面向中小学历史教学与历史仿真创新训练的 AI 实践平台。当前开发版本 **V0.10.28**；原创学生端视觉系统已覆盖展馆式全局壳、系统时间日晷首页、山河课程中心、可缩放历史地图、15 门独立课程头图、课程路线、通栏导读短片、交互式史卷阅读、人物助教浮窗、双旗舰历史情景推演、“问史卷”和本地优先学习书案。双旗舰课可接受自然问法，并把关键词、抉择、问答、临时笔记、正文、便签、手绘和导图汇入同一课时成果；学生可明确提交不可变成果版本、回看历史和教师反馈，教师可在独立成果工作区调阅并追加评价。最终 prerelease 仍须经过用户验收和发行物复核，不宣称公网或多学校生产部署已经完成。
